...
final class HeadersVO extends AbstractValueObject
{
    ...
    public function setAccept(ContentType $accept): self
    {
        $this->headers[HeaderType::ACCEPT->value] = $accept->value;
    ...
    public function setAcceptEncoding(ContentEncoding $acceptEncoding): self
    {
        $this->headers[HeaderType::ACCEPT_ENCODING->value] = $acceptEncoding->value;

        return $this;
    }

    public function setConnection(ConnectionType $connection): self
    {
        $this->headers[HeaderType::CONNECTION->value] = $connection->value;
    ...
    {
        $this->headers[HeaderType::CONTENT_TYPE->value] = $contentType->value;
    ...
    public function setContentEncoding(ContentEncoding $contentEncoding): self
    {
        $this->headers[HeaderType::CONTENT_ENCODING->value] = $contentEncoding->value;
    ...
    {
        $this->headers[HeaderType::CACHE_CONTROL->value] = $cacheControl->value;
